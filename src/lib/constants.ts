...
/**
 * 职位：通用版里「档案第二格」的选项。
 * 这一格的数据库列仍叫 grade——列名不动，改的只是它装什么、界面上叫什么（见 business-config.ts）。
 */
export const TITLES = [
  "创始人 / 老板",
  "高管",
...
/**
 * 外贸出口预设用的三组选项。客户是海外采购商、经销商和工程商，
 * 推进链条是询盘 → 报价 → 寄样 → 验厂 → 下单，和内销那套的差别主要在**来源**上：
 * 询盘平台、展会和开发信，而不是官网注册和电话咨询。
 */
